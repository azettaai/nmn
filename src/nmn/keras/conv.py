...
class _KernelBankRef:
    ...
    def __init__(self, bank_id: str, signature: tuple[Any, ...], capacity: int) -> None:
...
class _YatConvCore(_KernelBankSerializationMixin, Layer):
    """Backend-local rank-generic implementation; public wrappers retain defaults."""
    ...
    def __init__(
        ...
        strides: int | tuple[int, ...] | list[int] = 1,
        padding: str = "valid",
        data_format: str | None = None,
        dilation_rate: int | tuple[int, ...] | list[int] = 1,
        groups: int = 1,
        use_bias: bool = True,
        ...
        kernel_bank_size: int | None = None,
        kernel_bank_id: str = "default",
        kernel_bank: Any = None,
        kernel_initializer: Any = "orthogonal",
        ...
        **kwargs: Any,
        ...
        self.kernel_size = (
            ...
            else (kernel_size,) * self._rank
        )
        self.strides = (
            strides if isinstance(strides, (list, tuple)) else (strides,) * self._rank
        )
        ...
        self.dilation_rate = (
            ...
            else (dilation_rate,) * self._rank
        )
        if (
            self._rank == 1
            and any(stride != 1 for stride in self.strides)
            and any(dilation != 1 for dilation in self.dilation_rate)
        ):
        ...
        self.input_spec = InputSpec(ndim=self._rank + 2)
    ...
    def build(self, input_shape: Shape) -> None:
        ...
        input_dim = int(cast(int, input_shape[channel_axis]))
        ...
        self.input_spec = InputSpec(ndim=self._rank + 2, axes={channel_axis: input_dim})
        self.built = True
    ...
    def call(self, inputs: Tensor, training: bool | None = None) -> Tensor:
        ...
        if self._rank == 1 and self.padding == "causal":
    ...
    def compute_output_shape(self, input_shape: Shape) -> Shape:
        return cast(Shape, _conv_output_shape(self, input_shape))
...
class _YatConvTransposeCore(_KernelBankSerializationMixin, Layer):
    """Backend-local rank-generic implementation; public wrappers retain defaults."""
    ...
    def __init__(
        ...
        kernel_constraint: Any = None,
        bias_constraint: Any = None,
        output_padding: int | tuple[int, ...] | list[int] | None = None,
        output_shape_mode: str = "framework",
        **kwargs: Any,
    ) -> None:
        super().__init__(activity_regularizer=activity_regularizer, **kwargs)
        self.filters = validate_positive_int(filters, "filters")
        ...
        self.output_padding = _standardize_output_padding(output_padding, self._rank)
    ...
    def compute_output_shape(self, input_shape: Shape) -> Shape:
        return cast(Shape, _conv_transpose_output_shape(self, input_shape))
...
class YatConv2D(_YatConvCore):
    ...
    def __init__(
        ...
        filters: int,
        kernel_size: int | tuple[int, ...] | list[int],
        strides: int | tuple[int, ...] | list[int] = (1, 1),
        padding: str = "valid",
        data_format: str | None = None,
        dilation_rate: int | tuple[int, ...] | list[int] = (1, 1),
        groups: int = 1,
        use_bias: bool = True,
        constant_bias: float | bool | None = None,
        use_alpha: bool = True,
...
class YatConv3D(_YatConvCore):
    ...
    def __init__(
        ...
        filters: int,
        kernel_size: int | tuple[int, ...] | list[int],
        strides: int | tuple[int, ...] | list[int] = (1, 1, 1),
        padding: str = "valid",
        data_format: str | None = None,
        dilation_rate: int | tuple[int, ...] | list[int] = (1, 1, 1),
        groups: int = 1,
        use_bias: bool = True,
        constant_bias: float | bool | None = None,
        use_alpha: bool = True,
...
class YatConvTranspose1D(_YatConvTransposeCore):
...
class YatConvTranspose2D(_YatConvTransposeCore):
...
class YatConvTranspose3D(_YatConvTransposeCore):
